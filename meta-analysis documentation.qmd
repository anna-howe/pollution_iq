...
```
## Forrest Plots - Style options {.tabset}
:::{.panel-tabset}
# Standard (PM - Overall, random & mixed)
```{r}
    forest(m.pm_overall,
       sortvar = TE,
       prediction = TRUE,
...
leftcols =c("studlab", "Exposure Period", "Sample Size", "I2", "Q", "pval.Q", "tau2" )
leftlabs =c("Study", "Exposure Period", "Sample Size", "I2", "Q", "P", "Tau2" )

```
# JAMA (PM - Overall, random & mixed)
```{r}
    forest(m.pm_overall,
       layout = "JAMA",
       sortvar = TE,
       ...
       leftlabs = c("Study", "g", "SE", "weight"),
       fontsize = 6,
       spacing = 0.5)

```

# BMJ (PM - Overall, random & mixed)
```{r}
    forest(m.pm_overall,
       layout = "BMJ",
       sortvar = TE,
...
# Cochrane’s Review Manager 5 (PM - Overall, random & mixed)
```{r}
    forest(m.pm_overall,
       layout = "RevMan5",
       sortvar = TE,
